...
\begin{table}[]
    ...
    %% imagen acercada de fig 12 para ver fluctuaciones del viento
    %% tratard eincluir wavelet completo de ese evento
    ...
    \begin{figure}[h!]
      ...
      \caption{Frequency spectra of water level fluctuations in the estuary at sites in NM, DC and ML, and of wind surface stress.}
      \label{fig:freq}
    \end{figure}
